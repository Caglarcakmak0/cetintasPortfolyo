        ...
        <div className="container">
          <div className="about-intro">
            ...
            <div className="about-intro-content">
              ...
              <FadeContent blur duration={1200} easing="ease-out" delay={400} threshold={0.1} initialOpacity={0}>
          ...
          <div className="roadmap-section">
            ...
            <FadeContent blur duration={1200} easing="ease-out" delay={0} threshold={0.1} initialOpacity={0}>
          ...
          <div className="approach-section">
            ...
            <FadeContent blur duration={1200} easing="ease-out" delay={200} threshold={0.1} initialOpacity={0}>
